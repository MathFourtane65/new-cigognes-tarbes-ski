    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col text-center">
                ...
                <!-- <a href="/fichiers/dossier-inscription-2023-2024.pdf" class="btn btn-primary btn-lg" download>Télécharger le Dossier</a> -->
                <a href="/fichiers/XXXXX.pdf" class="btn btn-primary btn-lg disabled" download>Disponibilité prochaine</a>
            </div>
        </div>
    </div>
</body>

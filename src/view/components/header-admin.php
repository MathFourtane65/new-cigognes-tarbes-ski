...
<body>
    ...
    <div>
        ...
        <div class="row" style="width: 40%; margin:0 auto;">
            <div class="col">
                <a href="/admin" class="btn btn-outline-danger btn-header-admin" role="button">Accueil ADMIN</a>
            </div>
            <div class="col">
                <a href="/logout-admin" class="btn btn-outline-danger btn-header-admin" role="button">Déconnexion</a>
            </div>
